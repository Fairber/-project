...
public interface ScoreService {
	 ...
	 * 查询一个学生的一门课成绩
	 */
	List<ScoreCou> findStuOne(String stuNum, String courseName)
			throws SQLException;
	 ...
	 * 查询一个教师所带的课程
	 */
	PageBean selectTeaScore(int pageNo, int pageCount, String teaName,
			String stuName, String stuClass, String stuNum) throws SQLException;
	
	/*
	 * 学生所有成绩总和
	 */
	double findStuSc(String stuNum)throws SQLException;
