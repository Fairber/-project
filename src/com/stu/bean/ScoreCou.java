...
public class ScoreCou {
	...
	public String toString() {
		return "ScoreCou [courseName=" + courseName + ", courseCredit="
				+ courseCredit + ", courseHours=" + courseHours
				+ ", courseTeacher=" + courseTeacher + ", major=" + major
				+ ", courseDate=" + courseDate + ", scoreGrade=" + scoreGrade
				+ "]";
	}
