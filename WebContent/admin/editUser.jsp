		...
		<div class="div_ads">
			...
			<c:forEach var="list" items="${list }">
				<table>
					<tr>
						<td>账&nbsp;&nbsp;&nbsp;号：</td>
						<td><input type="text" name="userNum" class="put"
							value="${list.getUserNum() }" readonly="readonly" /></td>
					</tr>
					<tr>
						<td>姓&nbsp;&nbsp;&nbsp;名：</td>
					...
					<tr>
						<td>密&nbsp;&nbsp;&nbsp;码：</td>
						<td><input type="text" name="password" class="put"
							value="${list.getPassword() }" /></td>
					</tr>
					<tr>
						<td>联系电话：</td>
						<td><input type="text" name="phone" class="put"
							value="${list.getPhone() }" /></td>
					</tr>
					<tr>
